...
export const ChildPovertyRate: React.FC<Props> = (props) => {
    ...
    const q1Primary =
        primary.feature.properties[StateLevelVariable.Q1ChildPoverty].toFixed(
            1
        );

    const q4Primary =
        primary.feature.properties[StateLevelVariable.Q4ChildPoverty].toFixed(
            1
        );

    const q1Comparison =
        comparison.feature.properties[
            StateLevelVariable.Q1ChildPoverty
        ].toFixed(1);

    const q4Comparison =
        comparison.feature.properties[
            StateLevelVariable.Q4ChildPoverty
        ].toFixed(1);
